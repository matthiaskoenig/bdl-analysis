...
# alternative plot
# corrplot(hist_data[, col.accept], method="pie", type="full",  tl.cex=0.5, tl.col="black", col=col2(10))

# Get the top correlations for every factor
...
for (name in hist_facs){
  ...
  print(v.sorted[1:10])
  corrplot(t(as.matrix(v.sorted[1:10])), method="pie", type="full", 
           tl.cex=0.7, tl.col="black", col=col2(100))  
}
par(mfrow=c(1,1))
