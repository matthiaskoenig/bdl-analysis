...
Now we were interested in the actual time courses of the clusters. For the comparison of individual factors, for plotting of the members of the clusters and for the later decision trees the factors had to be normalized, to make them comparable with each other. The normalization was hereby performed for every factor separately based on
...
With the normalized factor data the mean time course plots are generated. These consist of the mean time course averaged over the repeats for all factors in the clusters and the mean cluster time course, averaged over all factors in the cluster.
``` {r plotClusters}
...
# TODO: create the single plots in the report
...
hist_facs <- BDLfactors$id[annova.accept & (BDLfactors$ftype %in% c("Antibodies", "Biochemistry", "Histology"))]
hist_facs
