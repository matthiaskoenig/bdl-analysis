...
Filter the results based on acceptance level. The cutoff for 
``` {r filtering}
p.accept = 0.05  # acceptance level, i.e if p.adjusted < p.accept
...
# the accepted subset
idx.accept = df.anova$p.holm<p.accept
  
# Create the subset of filtered data
