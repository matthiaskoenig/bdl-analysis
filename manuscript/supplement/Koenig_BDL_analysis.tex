...
\hypersetup{breaklinks=true,
            bookmarks=true,
            pdfauthor={Matthias Koenig (2015-10-22)},
...
\NormalTok{data_ADME =}\StringTok{ }\KeywordTok{t}\NormalTok{(}\KeywordTok{as.matrix}\NormalTok{(BDLmean[BDLfactors$ftype ==}\StringTok{ "GE_ADME"}\NormalTok{]))}
\NormalTok{data_ADME <-}\StringTok{ }\NormalTok{data_ADME[}\KeywordTok{rownames}\NormalTok{(data_ADME) !=}\StringTok{ "Actb.x"}\NormalTok{, ]}

\NormalTok{data_Cytokines =}\StringTok{ }\KeywordTok{t}\NormalTok{(}\KeywordTok{as.matrix}\NormalTok{(BDLmean[BDLfactors$ftype ==}\StringTok{ "GE_Cytokines"}\NormalTok{]))}
\NormalTok{data_Cytokines <-}\StringTok{ }\NormalTok{data_Cytokines[}\KeywordTok{rownames}\NormalTok{(data_Cytokines) !=}\StringTok{ "Actb.y"}\NormalTok{, ]}

\NormalTok{data_Fibrosis =}\StringTok{ }\KeywordTok{t}\NormalTok{(}\KeywordTok{as.matrix}\NormalTok{(BDLmean[BDLfactors$ftype ==}\StringTok{ "GE_Fibrosis"}\NormalTok{]))}
\NormalTok{data_Fibrosis <-}\StringTok{ }\NormalTok{data_Fibrosis[}\KeywordTok{rownames}\NormalTok{(data_Fibrosis) !=}\StringTok{ "Actb"}\NormalTok{, ]}

\CommentTok{# fold changes relative to sham mice (0 h) displayed in log2 scale}
\NormalTok{log2_to_control <-}\StringTok{ }\NormalTok{function(data)\{}
  \NormalTok{data <-}\StringTok{ }\NormalTok{data[}\KeywordTok{sort}\NormalTok{(}\KeywordTok{rownames}\NormalTok{(data)), ]  }\CommentTok{# sort by name}
  \NormalTok{reldata <-}\StringTok{ }\NormalTok{data[, }\DecValTok{2}\NormalTok{:}\KeywordTok{ncol}\NormalTok{(data)]/data[, }\DecValTok{1}\NormalTok{]}
  \NormalTok{log2_reldata <-}\StringTok{ }\KeywordTok{log2}\NormalTok{(reldata)  }
\NormalTok{\}}
